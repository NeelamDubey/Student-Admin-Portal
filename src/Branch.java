...
public class Branch extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        j1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CSE", "EEE", "ECE", "CE" }));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        setVisible(false);
        if(j1.getSelectedItem().equals("CSE"))
        new EnggResult().setVisible(true);
        else if(j1.getSelectedItem().equals("EEE"))
        new EnggResult1().setVisible(true);
        else if(j1.getSelectedItem().equals("CE"))
        new EnggResult2().setVisible(true);
        else if(j1.getSelectedItem().equals("ECE"))
